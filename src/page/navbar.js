...
const Navbar = () => {
  return (
    <>
    <Flex height={'15vh'} bgColor={'white'} p={10} boxShadow={'lg'} blur={4} width={'100%'} justify={'flex-start'} alignItems={'center'} flexDir={'row'} alignContent={'center'} pl={'2%'} py={'2%'} pr={'2%'} background={'white'}> 
    <Flex float={'left'} mr={'50%'}>
      ...
      <Flex id={'navbar'} justifyContent={'space-around'} width={'100%'}>
            ...
            <NavLink to="/about"><Text  className='navbar'  fontWeight={'bold'} fontFamily={'var(--font-family-secondary)'}>About</Text></NavLink>
